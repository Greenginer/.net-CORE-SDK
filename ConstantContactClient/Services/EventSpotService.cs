...
using ConstantContactClient.Components.EventSpot;
...
namespace ConstantContactClient.Services
{
    ...
    public class EventSpotService : BaseService, IEventSpotService
    {
        ...
        public IndividualEvent GetEventSpot(string eventId)
        {
            ...
            {
                throw new IllegalArgumentException(ConstantContactClient.Resources.Errors.InvalidId);
            }
        ...
        public ConstantContactClient.Components.EventSpot.Attribute PostEventItemAttribute(string eventId, string itemId, ConstantContactClient.Components.EventSpot.Attribute attribute)
        {
            if (string.IsNullOrWhiteSpace(eventId))
            {
                throw new IllegalArgumentException(ConstantContactClient.Resources.Errors.InvalidId);
            ...
            try
            {
                var attrib = response.Get<ConstantContactClient.Components.EventSpot.Attribute>();
                return attrib;
            }
            catch (Exception ex)
            {
        ...
        public ConstantContactClient.Components.EventSpot.Attribute PutEventItemAttribute(string eventId, string itemId, string attributeId, ConstantContactClient.Components.EventSpot.Attribute attribute)
        {
            if (string.IsNullOrWhiteSpace(eventId))
            {
                throw new IllegalArgumentException(ConstantContactClient.Resources.Errors.InvalidId);
        ...
        public ConstantContactClient.Components.EventSpot.Attribute GetEventItemAttribute(string eventId, string itemId, string attributeId)
        {
            if (string.IsNullOrWhiteSpace(eventId))
            {
                throw new IllegalArgumentException(ConstantContactClient.Resources.Errors.InvalidId);
        ...
        public List<ConstantContactClient.Components.EventSpot.Attribute> GetAllEventItemAttributes(string eventId, string itemId)
        {
            if (string.IsNullOrWhiteSpace(eventId))
            {
                throw new IllegalArgumentException(ConstantContactClient.Resources.Errors.InvalidId);
            ...
            try
            {
                var attrib =  response.Get<List<ConstantContactClient.Components.EventSpot.Attribute>>();
                return attrib;
            }
            catch (Exception ex)
            {
