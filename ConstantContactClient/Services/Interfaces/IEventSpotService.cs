...
namespace ConstantContactClient.Services
{
    ...
    public interface IEventSpotService
    {
        ...
        ConstantContactClient.Components.EventSpot.Attribute PostEventItemAttribute(string eventId, string itemId, ConstantContactClient.Components.EventSpot.Attribute attribute);
        ...
        ConstantContactClient.Components.EventSpot.Attribute PutEventItemAttribute(string eventId, string itemId, string attributeId, ConstantContactClient.Components.EventSpot.Attribute attribute);
        ...
        ConstantContactClient.Components.EventSpot.Attribute GetEventItemAttribute(string eventId, string itemId, string attributeId);
        ...
        List<ConstantContactClient.Components.EventSpot.Attribute> GetAllEventItemAttributes(string eventId, string itemId);
