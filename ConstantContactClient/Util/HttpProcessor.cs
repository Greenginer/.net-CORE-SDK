...
namespace ConstantContactClient.Util
{
    /// <summary>
    ...
    public class HttpProcessor : ProcessorBase
    {
        ...
        public RawApiResponse HttpRequest(string url, HttpMethod method, IContentType contentType, string accessToken, string apiKey, byte[] data)
        {
            ...
            request.Headers[X_ConstantContactClient_REQUEST_SOURCE_HEADER] = "sdk.NET." + GetClientAssemblyVersion().ToString();
        ...
        protected Version GetClientAssemblyVersion()
        {
